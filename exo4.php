...
// Function which takes the word to find in parameter
function playHangmanGame(string $wordToFind): void
{
    $wordToFindArr = [];
    ...
    while ($lettersToFind > 0) {
        ...
        $letterWordAttempt = readline("\nVeuillez entrer une lettre ou un mot : ");
